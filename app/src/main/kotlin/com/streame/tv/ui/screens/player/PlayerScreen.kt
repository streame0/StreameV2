...
import com.streame.tv.ui.components.NextEpisodeOverlay
import com.streame.tv.ui.components.StreamSelector
import com.streame.tv.ui.components.WaveLoadingDots
...
import com.streame.tv.ui.theme.PurpleDark
import com.streame.tv.ui.theme.PurpleLight
import com.streame.tv.ui.theme.PurplePrimary
...
fun PlayerScreen(
    ...
    DisposableEffect(Unit) {
        ...
        if (window != null && deviceType != com.streame.tv.util.DeviceType.TV) {
    ...
    DisposableEffect(frameRateActivity) {
        onDispose {
            frameRateActivity?.let { com.streame.tv.util.FrameRateUtils.restoreOriginalMode(it) }
        }
    }
        ...
        if (url != null) {
            ...
            frameRateActivity?.let { activity ->
                ...
                if (mode == "Off" || mode.isBlank()) {
                    ...
                    if (detection != null) {
                        com.streame.tv.util.FrameRateUtils.matchFrameRateAndWait(activity, detection.snapped)
                    }
                }
            }
    ...
    val isTablet = playerDeviceType == com.streame.tv.util.DeviceType.TABLET
    val isPhone = playerDeviceType == com.streame.tv.util.DeviceType.PHONE
            ...
            Box(modifier = Modifier.fillMaxSize()) {
                ...
                Row(
                        ...
                        if (seasonNumber != null && episodeNumber != null) {
                            Row(
                                ...
                                Text(
                                    ...
                                    style = StreameTypography.body.copy(fontSize = 16.sp),
                                    color = TextSecondary,
                                    maxLines = 1,
                                    overflow = TextOverflow.Ellipsis
                                )
                    ...
                    Column(horizontalAlignment = Alignment.End, modifier = Modifier.padding(end = 8.dp)) {
                        ...
                        if (!isTouchDevice) {
                            Text(currentTime.value, style = StreameTypography.body.copy(fontSize = 18.sp, fontWeight = FontWeight.Medium), color = TextSecondary, maxLines = 1)
                        }
                        if (endsAtTime.value.isNotBlank()) {
                            Text("${stringResource(R.string.ends_at)} ${endsAtTime.value}", style = StreameTypography.caption.copy(fontSize = 12.sp), color = TextSecondary.copy(alpha = 0.7f), maxLines = 1, modifier = Modifier.padding(top = 2.dp))
                        }
                    }
                }
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            ...
                            style = StreameTypography.label.copy(fontSize = if (isTouchDevice) 12.sp else 13.sp),
        ...
        AnimatedVisibility(
            ...
            Box(
                ...
                Text(
                    ...
                    style = StreameTypography.body.copy(fontSize = 18.sp, fontWeight = FontWeight.Medium),
                    color = Color.White
                )
            }
        }
    ...
    Column(
        ...
        Box(
            ...
            Box(
                ...
                if (!logoUrl.isNullOrBlank()) {
                    ...
                    Text(
                        title, style = StreameTypography.sectionTitle.copy(fontSize = 28.sp, fontWeight = FontWeight.Bold),
                        color = Color.White
                    )
                }
            }
        ...
        if (progress != null) {
            ...
            Text(
                ...
                style = StreameTypography.sectionTitle.copy(fontSize = 22.sp, fontWeight = FontWeight.SemiBold),
                color = Color.White
            )
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            if (subtitle != null) {
                Text(
                    text = subtitle,
                    style = StreameTypography.caption.copy(fontSize = 11.sp),
